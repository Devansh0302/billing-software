...
export async function GET() {
  try {
    ...
    // Cash/UPI/Card split
    const cashTotal = todayOrders.filter(o => o.payment_mode === 'CASH').reduce((s, o) => s + o.total_amount, 0);
    const upiTotal = todayOrders.filter(o => o.payment_mode === 'UPI').reduce((s, o) => s + o.total_amount, 0);
    const cardTotal = todayOrders.filter(o => o.payment_mode === 'CARD').reduce((s, o) => s + o.total_amount, 0);
