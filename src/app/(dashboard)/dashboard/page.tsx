...
export default function DashboardPage() {
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
      <h1 className="text-2xl font-bold mb-6" style={{ fontFamily: 'var(--font-heading)', color: '#1A1A1A' }}>
        Dashboard
      </h1>
      ...
      <div className="grid grid-cols-4 gap-4 mb-8">
        {statCards.map((card, index) => (
          <motion.div
            ...
            style={{ backgroundColor: '#FFFFFF', boxShadow: '0 1px 2px rgba(0,0,0,0.05)', border: '1px solid #E5E7EB' }}
          >
      ...
      {/* Hourly Sales Chart */}
      <div className="rounded-xl p-6 mb-8" style={{ backgroundColor: '#FFFFFF', border: '1px solid #E5E7EB', boxShadow: '0 1px 2px rgba(0,0,0,0.05)' }}>
