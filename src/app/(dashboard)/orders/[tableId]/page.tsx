...
import {
  ...
  CreditCard, Smartphone, Banknote, MessageCircle, Send
} from 'lucide-react';
...
export default function OrderPage() {
  ...
  }, [items, orderId, notes, guestCount, tableId, session]);
  ...
  const handlePrintKOT = async () => {
    ...
    try {
      ...
      if (res.ok) {
        toast.success('KOT sent to kitchen', { description: 'Kitchen order ticket has been printed' });
      } else {
                  ...
                  <div className="flex items-center justify-between mt-3">
                    ...
                    {qty > 0 ? (
                      ...
                      <button
                        ...
                        style={{ backgroundColor: '#ECFDF5', color: '#10B981', border: '1px solid #D1FAE5' }}
                      >
                        Add
                      </button>
                    )}
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center" style={{ backgroundColor: 'rgba(0,0,0,0.5)' }}>
          ...
          >
            ...
            <div className="print-area">
              ...
              <div className="px-5 py-2 text-xs space-y-1" style={{ borderTop: '1px dashed #E5E7EB', borderBottom: '1px dashed #E5E7EB' }}>
                ...
                <table className="w-full text-xs">
                  <thead>
                    <tr style={{ borderBottom: '1px solid #E5E7EB' }}>
                      <th className="text-left py-1.5 font-medium" style={{ color: '#6B7280' }}>Item</th>
                      <th className="text-center py-1.5 font-medium" style={{ color: '#6B7280' }}>Qty</th>
                      <th className="text-right py-1.5 font-medium" style={{ color: '#6B7280', fontFamily: 'var(--font-mono)' }}>Rate</th>
                      <th className="text-right py-1.5 font-medium" style={{ color: '#6B7280', fontFamily: 'var(--font-mono)' }}>Amt</th>
                    </tr>
                  </thead>
                  <tbody>
                    {items.map(item => (
                      <tr key={item.menu_item_id} style={{ borderBottom: '1px solid #F9FAFB' }}>
                        <td className="py-1.5" style={{ color: '#1A1A1A' }}>{item.name}</td>
                        <td className="text-center py-1.5" style={{ fontFamily: 'var(--font-mono)' }}>{item.quantity}</td>
                        <td className="text-right py-1.5" style={{ fontFamily: 'var(--font-mono)' }}>₹{item.unit_price}</td>
                        <td className="text-right py-1.5 font-medium" style={{ fontFamily: 'var(--font-mono)' }}>₹{item.total_price}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
              ...
              {/* Totals */}
              <div className="px-5 py-3 space-y-1" style={{ borderTop: '1px dashed #E5E7EB' }}>
                <div className="flex justify-between text-xs">
                  <span style={{ color: '#6B7280' }}>Subtotal</span>
