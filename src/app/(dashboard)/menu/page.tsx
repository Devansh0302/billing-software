    ...
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
      <div className="flex items-center gap-3 mb-6">
        <div className="w-9 h-9 rounded-xl flex items-center justify-center" style={{ backgroundColor: '#10B98120' }}>
          <UtensilsCrossed className="w-5 h-5" style={{ color: '#10B981' }} />
        </div>
        <div>
          <h1 className="text-2xl font-bold" style={{ fontFamily: 'var(--font-heading)', color: '#1A1A1A' }}>Menu Management</h1>
          <p className="text-xs" style={{ color: '#6B7280' }}>Manage categories, items, and pricing</p>
        </div>
      </div>
